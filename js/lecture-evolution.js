(function () {
  ...
  var sixKinds = {
    ...
    '盖': '形声', '此': '会意（从止、匕）', '身': '象形', '四': '象形', '大': '象形', '五': '指事', '常': '形声（从巾，尚声）',
  ...
  var ancientAvailability = {
    ...
    seal: '日月盈昃辰宿列张寒来暑往秋收冬藏闰余成岁律吕调阳云腾致雨露结为霜金生丽水玉出昆冈剑号阙巨珠称夜光果珍李柰菜姜重芥海咸河淡鳞潜翔羽龙帝火师鸟官皇人始字制文乃服衣裳推位让国有虞陶唐民伐罪发周殷汤坐朝问道垂拱平章爱育首黎臣伏戎羌体一遐迩王归宾率在鸣树凤白场驹食被木化草赖及万方盖此发身四大五常恭惟鞠养岂敢毁伤女慕贞絜男效才良过知必改能得莫忘罔谈彼靡短恃己长信使可覆器欲难量墨悲丝诗染羔赞羊'
  };
